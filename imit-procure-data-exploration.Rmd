...
Go through `title` descriptions and assign into categories based on presence/absence of im/it-related words (e.g. `software` `==` `imit-software`):
...
awards_imit %>% 
  ...
  labs(y = "Total Amount Awarded (million $)",
       ...
       subtitle = "Only includes awards through BCBids & BCDevExchange Code With Us at this time",

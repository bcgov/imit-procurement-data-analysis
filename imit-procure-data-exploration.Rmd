...
An exploration of IM/IT Procurement data for British Columbia. This document outlines the exploration phase---finding, getting and cleaning multiple, different data sources, determining which awards are IM/IT-related, and some descriptive summaries of the data.


### Raw Data

#### BCBid Awards from the B.C. Data Catalogue
...
#### BCDevExchange Code-With-Us Awards
...
#### Awards Over 10,000 & Direct Award Data from the Open Information Webpage

Data on contracts over $10,000 housed in PDF and XLS files---available by Ministry for each quarter from April 2017 to June 2019: [https://www2.gov.bc.ca/gov/content?id=AFBE378C5C684CF980CD6008364BD868](https://www2.gov.bc.ca/gov/content?id=AFBE378C5C684CF980CD6008364BD868)


Data on directly awarded contracts housed in PDF and XLS files---available by Ministry for each month from 2016-17 to June 2019: [https://www2.gov.bc.ca/gov/content?id=217BF2AE401E44F1A5DA3CB4C36E95AF](https://www2.gov.bc.ca/gov/content?id=217BF2AE401E44F1A5DA3CB4C36E95AF)
...
Look at the text by Ministry, as a start:
...
awards_imit <- awards_tidy %>%
  mutate(title = str_to_lower(title),
         category = case_when(str_detect(title, "software") ~ "imit-software",
